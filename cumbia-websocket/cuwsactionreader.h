 ...
 *
 * This class implements the CuWSActionI interface, which in turn implements CuThreadListener.
 *
 ...
 */
class CuWSActionReader: public CuWSActionI /* CuWSActionI implements CuThreadListener */
{
public:
