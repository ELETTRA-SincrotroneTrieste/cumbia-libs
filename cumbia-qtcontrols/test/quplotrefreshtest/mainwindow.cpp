...
MainWindow::MainWindow( QWidget* parent )
    : QMainWindow( parent )
{
    QuPlotPanel* panel = new QuPlotPanel();
    m_plot = new QuPlot();
    ...
    connect( panel, SIGNAL(settingsChanged(const QuPlotSettings&)),
        this, SLOT(applySettings(const QuPlotSettings&)) );
}
...
void MainWindow::applySettings( const QuPlotSettings& settings )
{
