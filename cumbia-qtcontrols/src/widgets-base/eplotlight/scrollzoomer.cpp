...
void ScrollZoomer::setZoomBase(bool do_replot)
{
    QwtPlotZoomer::setZoomBase(do_replot);
}

void ScrollZoomer::setZoomBase(const QRectF &r)
{
    QwtPlotZoomer::setZoomBase(r);
}
