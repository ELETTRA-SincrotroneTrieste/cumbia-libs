...
- Either
  ...
  b. run "make install" from the "build-cumbia-qtcontrols-Android_for_armeabi_v7a_GCC_..." folder
...
libcumbia-qtcontrols-qt5.so under

/libs/armeabi-v7a/

The same file can be found under the "build-cumbia-qtcontrols-Android_for_armeabi_v7a_GCC_..." folder after
a successful build.

================================== IMPORTANT NOTE ===========================================

The application making use of this library must include libcumbia-qtcontrols-qt5.so as dependency in Qt Creator in
...
If you depend on cubia-websocket, please read the README.ANDROID.txt under cumbia-websocket/
