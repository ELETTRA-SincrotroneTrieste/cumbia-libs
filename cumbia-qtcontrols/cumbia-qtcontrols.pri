...
lessThan(QT_MAJOR_CUMBIA_QTCONTROLS_VERSION, 5) {
    QTVER_SUFFIX = -qt$${QT_MAJOR_CUMBIA_QTCONTROLS_VERSION}
} else {
    QTVER_SUFFIX =
}
...
CUMBIA_QTCONTROLS_CUMBIA_QTCONTROLS_VERSION_HEX = 0x010300
CUMBIA_QTCONTROLS_VERSION = 1.3.0
...
DEFINES += CUMBIA_QTCONTROLS_CUMBIA_QTCONTROLS_VERSION_STR=\"\\\"$${CUMBIA_QTCONTROLS_VERSION}\\\"\" \
    CUMBIA_QTCONTROLS_CUMBIA_QTCONTROLS_VERSION=$${CUMBIA_QTCONTROLS_CUMBIA_QTCONTROLS_VERSION_HEX}
...
android-g++|wasm-emscripten {
    ...
    isEmpty(QWT_PKGCONFIG) {
        ...
        lessThan(QT_MAJOR_CUMBIA_QTCONTROLS_VERSION, 5) {
            ...
            QWT_QTVER_SUFFIX = -qt$${QT_MAJOR_CUMBIA_QTCONTROLS_VERSION}
        }
