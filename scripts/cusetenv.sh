...
if [ ! -r $DIR/config.sh ]; then
    ...
    # the file is written by scripts/cubuild.sh to save some variables.
    # among them, $install_prefix, if it was defined as shell environment
    # variable before install script execution
    #
