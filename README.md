...
Since version 2.0, a <a href="https://gitlab.elettra.eu/cs/lib/cumbia-world">cumbia-world</a>
super project collects libraries and plugins all together and provides a Makefile (with initial
support for *cmake*) for an automated build of the entire world. 
